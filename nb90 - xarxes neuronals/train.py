...
def main(args):
    ...
    _train_dataset = maDataset(df_train, train = True)
    _valid_dataset = maDataset(df_valid, train = False)
    
    _dataSet = maDataset(_csvdata)

    # dataloader
    _train_dataLoader = DataLoader(_train_dataset, batch_size = args.bSize, shuffle = True, num_workers = args.workers)
    _valid_dataLoader = DataLoader(_valid_dataset, batch_size = args.bSize, shuffle = False, num_workers = args.workers)
